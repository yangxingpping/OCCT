...
#ifndef _Geom_TearDrop_HeaderFile
#define _Geom_TearDrop_HeaderFile
...
class Geom_TearDrop;
DEFINE_STANDARD_HANDLE(Geom_TearDrop, Geom_Conic)
...
//! The Geom_TearDrop ellipse is parameterized by an angle:
...
class Geom_TearDrop : public Geom_Conic
{
...
public:
  ...
  Standard_EXPORT Geom_TearDrop(const gp_Teard& E);
  ...
  Standard_EXPORT Geom_TearDrop(const gp_Ax2& A2, const Standard_Real MajorRadius, const Standard_Real MinorRadius);
  
  //! Converts the gp_Elips ellipse E into this ellipse.
  Standard_EXPORT void SetElips (const gp_Teard& E);
  ...
  Standard_EXPORT gp_Teard Elips() const;
  ...
  DEFINE_STANDARD_RTTIEXT(Geom_TearDrop,Geom_Conic)
...
#endif // _Geom_TearDrop_HeaderFile
