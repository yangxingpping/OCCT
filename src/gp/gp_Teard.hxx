...
#ifndef _gp_Teard_HeaderFile
#define _gp_Teard_HeaderFile
...
public:
  ...
  gp_Teard (const gp_Ax2& theA2, const Standard_Real theMajorRadius, const Standard_Real theMinorRadius)
  : pos (theA2),
    ...
    minorRadius (theMinorRadius)
  {
    Standard_ConstructionError_Raise_if (theMinorRadius < 0.0 || theMajorRadius < theMinorRadius,
      "gp_Teard() - invalid construction parameters");
  }
  ...
  void SetMajorRadius (const Standard_Real theMajorRadius)
  {
    Standard_ConstructionError_Raise_if (theMajorRadius < minorRadius,
       "gp_Teard::SetMajorRadius() - major radius should be greater or equal to minor radius");
    majorRadius = theMajorRadius;
  }
  ...
  void SetMinorRadius (const Standard_Real theMinorRadius)
  {
    Standard_ConstructionError_Raise_if (theMinorRadius < 0.0 || majorRadius < theMinorRadius,
      "gp_Teard::SetMinorRadius() - minor radius should be a positive number lesser or equal to major radius");
    minorRadius = theMinorRadius;
  }
  ...
  Standard_NODISCARD Standard_EXPORT gp_Teard Mirrored (const gp_Pnt& theP) const;

  Standard_EXPORT void Mirror (const gp_Ax1& theA1);

  //! Performs the symmetrical transformation of an ellipse with
  //! respect to an axis placement which is the axis of the symmetry.
  Standard_NODISCARD Standard_EXPORT gp_Teard Mirrored (const gp_Ax1& theA1) const;
  ...
  Standard_NODISCARD Standard_EXPORT gp_Teard Mirrored (const gp_Ax2& theA2) const;

  void Rotate (const gp_Ax1& theA1, const Standard_Real theAng) { pos.Rotate (theA1, theAng); }

  //! Rotates an ellipse. theA1 is the axis of the rotation.
  //! theAng is the angular value of the rotation in radians.
  Standard_NODISCARD gp_Teard Rotated (const gp_Ax1& theA1, const Standard_Real theAng) const
  {
    gp_Teard anE = *this;
  ...
  Standard_NODISCARD gp_Teard Scaled (const gp_Pnt& theP, const Standard_Real theS) const;

  void Transform (const gp_Trsf& theT);

  //! Transforms an ellipse with the transformation theT from class Trsf.
  Standard_NODISCARD gp_Teard Transformed (const gp_Trsf& theT) const;

  void Translate (const gp_Vec& theV) { pos.Translate (theV); }

  //! Translates an ellipse in the direction of the vector theV.
  //! The magnitude of the translation is the vector's magnitude.
  Standard_NODISCARD gp_Teard Translated (const gp_Vec& theV) const
  {
    gp_Teard anE = *this;
  ...
  Standard_NODISCARD gp_Teard Translated (const gp_Pnt& theP1, const gp_Pnt& theP2) const
  {
    gp_Teard anE = *this;
...
// purpose  :
// =======================================================================
inline gp_Ax1 gp_Teard::Directrix1() const
{
  Standard_Real anE = Eccentricity();
  Standard_ConstructionError_Raise_if (anE <= gp::Resolution(), "gp_Teard::Directrix1() - zero eccentricity");
...
// purpose  :
// =======================================================================
inline gp_Ax1 gp_Teard::Directrix2() const
{
  Standard_Real anE = Eccentricity();
  Standard_ConstructionError_Raise_if (anE <= gp::Resolution(), "gp_Teard::Directrix2() - zero eccentricity");
  gp_XYZ anOrig = pos.XDirection().XYZ();
  anOrig.Multiply (-majorRadius / anE);
  anOrig.Add (pos.Location().XYZ());
  return gp_Ax1 (gp_Pnt (anOrig), pos.YDirection());
...
// purpose  :
// =======================================================================
inline Standard_Real gp_Teard::Eccentricity() const
{
  if (majorRadius == 0.0)
  {
    return 0.0;
...
// purpose  :
// =======================================================================
inline gp_Pnt gp_Teard::Focus1() const
{
...
// purpose  :
// =======================================================================
inline gp_Pnt gp_Teard::Focus2() const
{
  Standard_Real aC = sqrt (majorRadius * majorRadius - minorRadius * minorRadius);
  const gp_Pnt& aPP = pos.Location();
  const gp_Dir& aDD = pos.XDirection();
...
// purpose  :
// =======================================================================
inline Standard_Real gp_Teard::Parameter() const
{
  if (majorRadius == 0.0)
  {
    return 0.0;
...
// purpose  :
// =======================================================================
inline void gp_Teard::Scale (const gp_Pnt& theP,
...
// purpose  :
// =======================================================================
inline gp_Teard gp_Teard::Scaled (const gp_Pnt& theP,
...
// purpose  :
// =======================================================================
inline void gp_Teard::Transform (const gp_Trsf& theT)
{
...
// purpose  :
// =======================================================================
inline gp_Teard gp_Teard::Transformed (const gp_Trsf& theT) const
{
  gp_Teard anE = *this;
